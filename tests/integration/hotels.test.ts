...
import { createEnrollmentWithAddress, createTicketPost, createTicketType, createUser, generateCreditCardData, ticketPost } from '../factories';
...
describe('GET /hotels/:hotelId', () => {
    ...
    describe('Token ok', () => {
        ...
        it('Retornar 404 se o hotel com id informado não for valido', async () => {
            ...
            const ticketResponse = await createTicketPost(enrollmentResponse.id, ticketTypeResponse.id, TicketStatus.RESERVED);
